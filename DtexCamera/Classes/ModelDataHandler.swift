...
// https://github.com/tensorflow/examples/blob/master/lite/examples/gesture_classification/ios/GestureClassification/ModelDataHandler/ModelDataHandler.swift
 ...
 */
internal func centerThumbnail(from pixelBuffer: CVPixelBuffer, size: CGSize ) -> CVPixelBuffer? {
